...
var dir : DirectoryInfo= new DirectoryInfo(Directory.GetCurrentDirectory() + OOOQODCODO.extensionPath + "Textures/Road Textures/");

assetPath = OOOQODCODO.extensionPath.Substring(1, OOOQODCODO.extensionPath.Length - 1);
...
var road : GameObject = roadscript.OOCQCQDOQO.road;
if(road != null){
